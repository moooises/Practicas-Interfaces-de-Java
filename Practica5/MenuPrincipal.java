...
public class MenuPrincipal{
	...
	public static String[] alt= {"Nulo","5Xn-1 mod 2^5","7Xn-1 mod 2^5","3Xn-1 mod 31","7^5Xn-1 mod (2^31-1)","(Wn-Xn+Yn) mod 32362","Fishman and Moore","RANDU"};
...
//---------
	...
	public static JTextField MediaH;
//-------
	public static GridBagConstraints e = new GridBagConstraints();
	public static JFrame Entri = new JFrame("Curva de Entriopia Espacial");
	public static JLabel EntriopiaMedia,Temp;
	public static JTextField MediaE,temp,Tresp;//Reservado para el lugar donde mostrar el valor medio--//public static 
	...
	public static void Boton(){
		...
		Start.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
					...
					ca= new ca1DSimulator(Estadosi,Geni,ragoi,rulei,front,GAlt,275,grafico,curva);
		...
		BHamming.addActionListener(new ActionListener(){
				...
				if(p4){
					...
					H.act(ca.VectorHamming());
					H.repaint();
					
					MediaH.setText(Double.toString(H.media()));
					}
				}
		});
		BEntriopia.addActionListener(new ActionListener(){
				...
				if(p4){
					...
					En.act(ca.MatrizEntriopia(),Estadosi,Geni);
					En.repaint();
					double T=En.media(ca.Total());
					MediaE.setText(Double.toString(T));
					BotonE();
					}
				}
		});
	...
	public static void BotonE(){
		BTemp.addActionListener(new ActionListener(){
				...
				double ET=En.ETemporal(ca.Total(),tempi);
				Tresp.setText(Double.toString(ET));
				}
		});
		
	}		
	
	public static void CrearFrameH(){
	...
	//	h.gridheight=1;
		//h.fill=GridBagConstraints.BOTH;
		MediaH= new JTextField();//String valor=""; Media.setText(valor); 
		Hamin.add(MediaH,h);
		h.weightx=0;
		h.weighty=0;
		//Hamin.pack();
	...
	public static void CrearFrameE(){
		...
		//-------------
			...
			e.gridheight=1;
			e.fill=GridBagConstraints.BOTH;
			MediaE= new JTextField();//String valor=""; Media.setText(valor); 
			e.weightx=1.0;
			e.weighty=1.0;
			Entri.add(MediaE,e);
			e.weightx=0;
			...
			e.gridheight=1;
			e.fill=GridBagConstraints.BOTH;
			Temp= new JLabel("Entripia Temporal:");//String valor=""; Media.setText(valor); 
			e.weightx=1.0;
			e.weighty=1.0;
			Entri.add(Temp,e);
			e.weightx=0;
			...
			e.gridheight=1;
			e.fill=GridBagConstraints.BOTH;
			temp= new JTextField("0");//String valor=""; Media.setText(valor); 
			e.weightx=1.0;
			e.weighty=1.0;
			Entri.add(temp,e);
			e.weightx=0;
